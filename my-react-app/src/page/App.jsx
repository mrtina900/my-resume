...
function App() {
  ...
  return (
    <div className="page-container">
      ...
      {/* Main Flex Wrapper for Side-by-Side */}
      <div className="resumes-flex-wrapper" style={{ display: 'flex', gap: '30px', justifyContent: 'center', padding: '40px' }}>
        
        {/* MARTINA'S FULL RESUME */}
        <div className="resume-paper" style={{ flex: 1, maxWidth: '800px' }}>
          <header className="header-section">
            ...
            <div className="header-content">
              ...
              <div className="contact-grid">
                <div className="contact-item"><Icon name="phone" /> +6017230940</div>
                <div className="contact-item">
                  <Icon name="mail" /> 
                  <a href="mailto:martinastephen18@gmail.com">martinastephen18@gmail.com</a>
                </div>
                <div className="contact-item"><Icon name="map" /> Kapit, Sarawak</div>
                <div className="contact-item">
                  <Icon name="link" /> 
          ...
          <div className="resume-body">
            ...
            <main className="main-content">
              ...
              <section style={{ marginBottom: '40px' }}>
                ...
                {[
                  { title: "Awareness App", tech: "Java Swing", year: "2025", desc: ["Developed an interactive learning/quiz desktop application.", "Designed GUI using Java Swing assets.", "Collaborated in an Agile team using Git."] },
                  { title: "Health App UI/UX", tech: "Figma", year: "2025", desc: ["Designed high-fidelity mobile health tracking prototypes.", "Applied UI/UX principles for optimal user flow."] },
                  { title: "Software Estimation Project", tech: "Project Management", year: "2025", desc: ["Conducted cost/effort estimation using Agile Story Points, UCP, and COCOMO.", "Produced comprehensive budget and timeline reports."] },
                  { title: "SafeDrive Vehicle System", tech: "C & MySQL", year: "2024", desc: ["Architected database for customers, vehicles, and payments.", "Implemented rigorous data integrity checks."] },
                  { title: "Claim Adjuster System", tech: "Python", year: "2024", desc: ["Built claim submission system using OOP concepts.", "Implemented validation and exception handling."] }
                ].map((project, index) => (
